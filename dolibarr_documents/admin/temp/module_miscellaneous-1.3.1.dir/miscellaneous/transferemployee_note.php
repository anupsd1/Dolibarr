...
$hookmanager->initHooks(array('transferemployeenote'));     // Note that conf->hooks_modules contains array
...
if ($id > 0 || ! empty($ref))
{
	...
	dol_fiche_head($head, 'note', $langs->trans("TransferEmployee"), -1, 'transferemployee@miscellaneous');
