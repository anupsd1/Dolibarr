...
$hookmanager->initHooks(array('transferemployeeagenda'));     // Note that conf->hooks_modules contains array
...
if ($object->id > 0)
{
	...
	dol_fiche_head($head, 'agenda', $langs->trans("TransferEmployee"), -1, 'transferemployee@miscellaneous');
