...
$hookmanager->initHooks(array('transferemployeedocument'));     // Note that conf->hooks_modules contains array
...
if ($object->id)
{
	...
	dol_fiche_head($head, 'document', $langs->trans("TransferEmployee"), -1, 'transferemployee@miscellaneous');
