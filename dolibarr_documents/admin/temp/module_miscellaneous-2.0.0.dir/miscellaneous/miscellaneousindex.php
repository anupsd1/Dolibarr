...
/**
 *	\file       htdocs/miscellaneous/template/miscellaneousindex.php
 *	\ingroup    miscellaneous
 *	\brief      Home page of miscellaneous top menu
 */
...
$langs->loadLangs(array("miscellaneous@miscellaneous"));

$action=GETPOST('action', 'alpha');


// Securite acces client
if (! $user->rights->miscellaneous->read) accessforbidden();
...
llxHeader("",$langs->trans("MiscellaneousArea"));

print load_fiche_titre($langs->trans("MiscellaneousArea"),'','miscellaneous.png@miscellaneous');
...
// Draft MyObject
if (! empty($conf->miscellaneous->enabled) && $user->rights->miscellaneous->read)
{
	$langs->load("orders");
