...
dol_include_once("/miscellaneous/class/myobject.class.php");


/**
 * mailing_mailinglist_miscellaneous
 */
class mailing_mailinglist_miscellaneous_myobject extends MailingTargets
{
	// CHANGE THIS: Put here a name not already used
	var $name='mailinglist_miscellaneous_myobject';
	...
	var $picto='miscellaneous@miscellaneous';
	var $db;
	...
	function __construct($db)
	{
		...
		{
			$this->enabled=in_array('miscellaneous',$conf->modules)?1:0;
		}
	}
	...
	function url($id)
	{
		return '<a href="'.dol_buildpath('/miscellaneous/myobject_card.php',1).'?id='.$id.'">'.img_object('',"generic").'</a>';
	}
	...
	function add_to_target($mailing_id,$filtersarray=array())
	{
		...
		if ($result)
		{
			...
			dol_syslog("mailinglist_miscellaneous_myobject.modules.php: mailing ".$num." targets found");
