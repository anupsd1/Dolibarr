...
/**
 * \file        class/dailyprogress.class.php
 * \ingroup     miscellaneous
 * \brief       This file is a CRUD class file for DailyProgress (Create/Read/Update/Delete)
 */
...
/**
 * Class for DailyProgress
 */
class DailyProgress extends CommonObject
{
	/**
	 * @var string ID to identify managed object
	 */
	public $element = 'dailyprogress';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'miscellaneous_dailyprogress';
	/**
	 * @var int  Does dailyprogress support multicompany module ? 0=No test on entity, 1=Test with field entity, 2=Test with link by societe
	 */
	public $ismultientitymanaged = 0;
	/**
	 * @var int  Does dailyprogress support extrafields ? 0=No, 1=Yes
	 */
	public $isextrafieldmanaged = 1;
	/**
	 * @var string String with name of icon for dailyprogress. Must be the part after the 'object_' into object_dailyprogress.png
	 */
	public $picto = 'dailyprogress@miscellaneous';
	...
	public $fields=array(
		...
		'curuser' => array('type'=>'integer:stockcustomlink', 'label'=>'Current User', 'visible'=>1, 'enabled'=>1, 'position'=>4, 'notnull'=>-1,),
		'usergr' => array('type'=>'varchar(128)', 'label'=>'Site', 'visible'=>1, 'enabled'=>1, 'position'=>11, 'notnull'=>-1,),
		'newusrss' => array('type'=>'integer:myownlink', 'label'=>'Trainee 1', 'visible'=>1, 'enabled'=>1, 'position'=>13, 'notnull'=>-1,),
		'newuara' => array('type'=>'integer:myownlink', 'label'=>'Trainee 2', 'visible'=>1, 'enabled'=>1, 'position'=>16, 'notnull'=>-1,),
		...
		'survey' => array('type'=>'integer:SurveyMeter:custom/miscellaneous/class/surveymeter.class.php', 'label'=>'Survey Meter', 'visible'=>1, 'enabled'=>1, 'position'=>24, 'notnull'=>-1,),
		'dos' => array('type'=>'integer:Dosimeter:custom/miscellaneous/class/dosimeter.class.php', 'label'=>'Dosimeter', 'visible'=>1, 'enabled'=>1, 'position'=>26, 'notnull'=>-1,),
		...
		'total' => array('type'=>'double', 'label'=>'Total', 'visible'=>1, 'enabled'=>1, 'position'=>2022, 'notnull'=>-1,),
	 ...
	 */
	//public $table_element_line = 'dailyprogressdet';
	/**
	 * @var int    Field with ID of parent key if this field has a parent
	 */
	//public $fk_element = 'fk_dailyprogress';
	/**
	 * @var int    Name of subtable class that manage subtable lines
	 */
	//public $class_element_line = 'DailyProgressline';
	/**
	 * @var array  Array of child tables (child tables to delete before deleting a record)
	 */
	//protected $childtables=array('dailyprogressdet');
	/**
	 * @var DailyProgressLine[]     Array of subtable lines
	 */
	//public $lines = array();
	...
	/*public function fetchLines()
	{
		...
		// Load lines with object DailyProgressLine
	...
	function getNomUrl($withpicto=0, $option='', $notooltip=0, $morecss='', $save_lastsearch_value=-1)
	{
        ...
        $label = '<u>' . $langs->trans("DailyProgress") . '</u>';
        $label.= '<br>';
        $label.= '<b>' . $langs->trans('Ref') . ':</b> ' . $this->ref;

        $url = dol_buildpath('/miscellaneous/dailyprogress_card.php',1).'?id='.$this->id;
        ...
        if (empty($notooltip))
        {
            ...
            {
                $label=$langs->trans("ShowDailyProgress");
...
/**
 * Class DailyProgressLine. You can also remove this and generate a CRUD class for lines objects.
 */
/*
class DailyProgressLine
{
	// @var int ID
	public $id;
