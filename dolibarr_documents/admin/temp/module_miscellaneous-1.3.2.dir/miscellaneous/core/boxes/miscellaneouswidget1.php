...
/**
 * \file    modulebuilder/template/core/boxes/miscellaneouswidget1.php
 * \ingroup miscellaneous
 * \brief   Widget provided by Miscellaneous
 *
 ...
 */
class miscellaneouswidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "miscellaneousbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "miscellaneous@miscellaneous";
	 ...
	 */
	public $depends = array('miscellaneous');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->miscellaneous->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/miscellaneous/class/miscellaneous.class.php";

		// Populate the head at runtime
		$text = $langs->trans("MiscellaneousBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_miscellaneous@miscellaneous',
