...
class modMiscellaneous extends DolibarrModules
{
	...
	public function __construct($db)
	{
        ...
        */
		...
		/* BEGIN MODULEBUILDER LEFTMENU EMPLOYEETRANSFER
		...
		*/
		...
		/* */
                ...
                $this->menu[$r++]=array(
                				'fk_menu'=>'fk_mainmenu=miscellaneous',	    // '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
								'type'=>'left',			                // This is a Left menu entry
								'titre'=>'List SafetyEqCheck',
								'mainmenu'=>'miscellaneous',
								'leftmenu'=>'miscellaneous_safetyeqcheck',
								'url'=>'/miscellaneous/safetyeqcheck_list.php',
								'langs'=>'miscellaneous@miscellaneous',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
								'position'=>1100+$r,
								'enabled'=>'$conf->miscellaneous->enabled',  // Define condition to show or hide menu entry. Use '$conf->miscellaneous->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
								'perms'=>'1',			                // Use 'perms'=>'$user->rights->miscellaneous->level1->level2' if you want your menu with a permission rules
								...
								'user'=>2);				                // 0=Menu for internal users, 1=external users, 2=both
		$this->menu[$r++]=array(
                				'fk_menu'=>'fk_mainmenu=miscellaneous,fk_leftmenu=miscellaneous_safetyeqcheck',	    // '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
								'type'=>'left',			                // This is a Left menu entry
								'titre'=>'New SafetyEqCheck',
								'mainmenu'=>'miscellaneous',
								'leftmenu'=>'miscellaneous_safetyeqcheck',
								'url'=>'/miscellaneous/safetyeqcheck_card.php?action=create',
								'langs'=>'miscellaneous@miscellaneous',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
								'position'=>1100+$r,
								'enabled'=>'$conf->miscellaneous->enabled',  // Define condition to show or hide menu entry. Use '$conf->miscellaneous->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
								'perms'=>'1',			                // Use 'perms'=>'$user->rights->miscellaneous->level1->level2' if you want your menu with a permission rules
		...
		$this->menu[$r++]=array(
                ...
                $this->menu[$r++]=array(
                				'fk_menu'=>'fk_mainmenu=miscellaneous',	    // '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
								'type'=>'left',			                // This is a Left menu entry
								'titre'=>'List EmployeeTransfer',
								'mainmenu'=>'miscellaneous',
								'leftmenu'=>'miscellaneous_employeetransfer',
								'url'=>'/miscellaneous/employeetransfer_list.php',
								'langs'=>'miscellaneous@miscellaneous',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
								'position'=>1100+$r,
								'enabled'=>'$conf->miscellaneous->enabled',  // Define condition to show or hide menu entry. Use '$conf->miscellaneous->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
								'perms'=>'1',			                // Use 'perms'=>'$user->rights->miscellaneous->level1->level2' if you want your menu with a permission rules
								...
								'user'=>2);				                // 0=Menu for internal users, 1=external users, 2=both
		$this->menu[$r++]=array(
                				'fk_menu'=>'fk_mainmenu=miscellaneous,fk_leftmenu=miscellaneous_employeetransfer',	    // '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
								'type'=>'left',			                // This is a Left menu entry
								'titre'=>'New EmployeeTransfer',
								'mainmenu'=>'miscellaneous',
								'leftmenu'=>'miscellaneous_employeetransfer',
								'url'=>'/miscellaneous/employeetransfer_card.php?action=create',
								'langs'=>'miscellaneous@miscellaneous',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
								'position'=>1100+$r,
								'enabled'=>'$conf->miscellaneous->enabled',  // Define condition to show or hide menu entry. Use '$conf->miscellaneous->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
								'perms'=>'1',			                // Use 'perms'=>'$user->rights->miscellaneous->level1->level2' if you want your menu with a permission rules
                ...
                $this->menu[$r++]=array(
                				'fk_menu'=>'fk_mainmenu=miscellaneous',	    // '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
								'type'=>'left',			                // This is a Left menu entry
								'titre'=>'List AdvanceSalary',
								'mainmenu'=>'miscellaneous',
								'leftmenu'=>'miscellaneous_advancesalary',
								'url'=>'/miscellaneous/advancesalary_list.php',
								'langs'=>'miscellaneous@miscellaneous',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
								'position'=>1100+$r,
								'enabled'=>'$conf->miscellaneous->enabled',  // Define condition to show or hide menu entry. Use '$conf->miscellaneous->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
								'perms'=>'1',			                // Use 'perms'=>'$user->rights->miscellaneous->level1->level2' if you want your menu with a permission rules
								...
								'user'=>2);				                // 0=Menu for internal users, 1=external users, 2=both
		$this->menu[$r++]=array(
                				'fk_menu'=>'fk_mainmenu=miscellaneous,fk_leftmenu=miscellaneous_advancesalary',	    // '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
								'type'=>'left',			                // This is a Left menu entry
								'titre'=>'New AdvanceSalary',
								'mainmenu'=>'miscellaneous',
								'leftmenu'=>'miscellaneous_advancesalary',
								'url'=>'/miscellaneous/advancesalary_card.php?action=create',
								'langs'=>'miscellaneous@miscellaneous',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
								'position'=>1100+$r,
								'enabled'=>'$conf->miscellaneous->enabled',  // Define condition to show or hide menu entry. Use '$conf->miscellaneous->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
								'perms'=>'1',			                // Use 'perms'=>'$user->rights->miscellaneous->level1->level2' if you want your menu with a permission rules
		...
		/* END MODULEBUILDER LEFTMENU EMPLOYEETRANSFER */


		// Exports
		//$r=1;

		/* BEGIN MODULEBUILDER EXPORT EMPLOYEETRANSFER */
		/*
		...
		$r++; */
		/* END MODULEBUILDER EXPORT EMPLOYEETRANSFER */
	}
