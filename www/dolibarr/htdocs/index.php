...
//print "<form action='custom\injotech\mycsvimport.php'><input type='button' value='mybutton' onclick='custom\injotech\mycsvimport.php'></form>";
/*
 * Actions
 */
...
if (empty($user->societe_id))
{
    ...
    print "<input type='button' value='mybutton' onClick='dolibarr/custom/injotech/mycsvimport.php'>";
    $object=new stdClass();
    $parameters=array();
    $action='';
