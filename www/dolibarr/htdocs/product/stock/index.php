...
//Changed $langs->trans("StocksArea") to $langs->trans("Sites Area") on line 47
print load_fiche_titre($langs->trans("Sites Area"));
...
if (! empty($conf->global->MAIN_SEARCH_FORM_ON_HOME_AREAS))     // This is useless due to the global search combo
{
    ...
    print $langs->trans("Site").':</td><td><input class="flat" type="text" size="18" name="sall"></td><td rowspan="2"><input type="submit" value="'.$langs->trans("Search").'" class="button"></td></tr>';
    print "</table></form><br>";
}
...
if ($result)
{
    ...
    print '<tr class="liste_titre"><th colspan="2">'.$langs->trans("Sites").'</th></tr>';
