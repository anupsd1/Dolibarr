...
$fieldstosearchall = array(
	'u.login'=>"Login",
        //The following two lines were modified by Anup
	'u.lastname'=>"Name as on Aadhar",
	'u.firstname'=>"Name as on Bank Account",
...
$arrayfields=array(
	'u.login'=>array('label'=>$langs->trans("Login"), 'checked'=>1),
        //The following two lines were modified by Anup
	'u.lastname'=>array('label'=>$langs->trans("Name as on Aadhar"), 'checked'=>1),
	'u.firstname'=>array('label'=>$langs->trans("Name as on Bank Account"), 'checked'=>1),
...
//The follwing two lines were modified by Anup
if (! empty($arrayfields['u.lastname']['checked']))       print_liste_field_titre("Name as on Aadhar",$_SERVER['PHP_SELF'],"u.lastname",$param,"","",$sortfield,$sortorder);
if (! empty($arrayfields['u.firstname']['checked']))      print_liste_field_titre("Name as on Bank Account",$_SERVER['PHP_SELF'],"u.firstname",$param,"","",$sortfield,$sortorder);
