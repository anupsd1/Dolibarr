...
if ($action == 'create' || $action == 'adduserldap')
{
	...
	print '<td class="titlefieldcreate"><span class="fieldrequired">'.$langs->trans("Name as on Aadhar").'</span></td>';
	print '<td>';
	...
	// Firstname
        //The following line was modified by Anup
	print '<tr><td>'.$langs->trans("Name as on Bank Account").'</td>';
	print '<td>';
...
else
{
	...
	if ($id > 0)
	{
		...
		if ($action == 'edit' && ($canedituser || $caneditfield || $caneditpassword || ($user->id == $object->id)))
		{
			...
			print "<tr>";
                        //The following line was modified by Anup
			print '<td class="titlefield fieldrequired">'.$langs->trans("Name as on Aadhar").'</td>';
			print '<td>';
