...
if ($result)
{
	...
	print_barre_liste($langs->trans("List of Sites"), $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, '', $num, $totalnboflines, 'title_generic.png', 0, $newcardbutton, '', $limit);
	...
	//print_liste_field_titre("LocationSummary",$_SERVER["PHP_SELF"], "e.lieu","",$param,"",$sortfield,$sortorder);
        print_liste_field_titre("Site in Charge",$_SERVER["PHP_SELF"], "e.lieu","",$param,"",$sortfield,$sortorder);
