...
if ($action == 'create')
{
        //The following line was modified by Anup
	print load_fiche_titre($langs->trans("New Site"));
	...
	//print '<tr><td>'.$langs->trans("LocationSummary").'</td><td><input name="lieu" size="40" value="'.(!empty($object->lieu)?$object->lieu:'').'"></td></tr>';
        print '<tr><td>'.$langs->trans("Site in Charge").'</td><td><input name="lieu" size="40" value="'.(!empty($object->lieu)?$object->lieu:'').'"></td></tr>';

        //Anup parent entrepot row removed by Anup
	// Parent entrepot
...
//	print '</td></tr>';
	...
	print '</textarea></td></tr>';
        ...
        //Zip code and town removed by Anup
	// Zip / Town
	...
	if ($id > 0 || $ref)
	{
		...
		if ($action <> 'edit' && $action <> 're-edit')
		{
			...
			//$morehtmlref.=$langs->trans("LocationSummary").' : '.$object->lieu;
                        $morehtmlref.=$langs->trans("Site in Charge").' : '.$object->lieu;
        	$morehtmlref.='</div>';
        	...
        	print '<table class="border" width="100%">';
                ...
                //Parent entrepot removed by ANup
//			// Parent entrepot
//			$e = new Entrepot($db);
...
//			}
		...
		if (($action == 'edit' || $action == 're-edit') && 1)
		{
			...
			//print '<tr><td>'.$langs->trans("LocationSummary").'</td><td><input name="lieu" size="40" value="'.$object->lieu.'"></td></tr>';
                        print '<tr><td>'.$langs->trans("Site in Charge").'</td><td><input name="lieu" size="40" value="'.$object->lieu.'"></td></tr>';
