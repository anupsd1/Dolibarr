...
class FormProduct
{
	 ...
	 */
	function selectWarehouses($selected='',$htmlname,$filterstatus='',$empty=0,$disabled=0,$fk_product=0,$empty_label='', $showstock=0, $forcecombo=0, $events=array(), $morecss='minwidth200', $exclude='', $showfullpath=1)
	{
